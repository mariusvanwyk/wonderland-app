...
import {VehicleCategoriesServices} from "./admin/services/VehicleCategoriesServices";

const vehicleCategoriesServices : VehicleCategoriesServices = new VehicleCategoriesServices()
...
const router = createBrowserRouter([
    ...
    {path: "/vehicle-categories", element: <VehicleCategories services={vehicleCategoriesServices}/>},
