...
const ItemTechnicalDetails = ({state}:Properties) => {
    ...
    const getDateTimeAsString = (date : Date | undefined) => {
        if (!date) {
            return "";
        } else {
            ...
            <Col sm={12} xl={6}>
                <Form.Group className="mb-3" controlId="vehicleCategory.id">
                    <Row>
                        ...
                        <Col sm={8}><Form.Text>{getDateTimeAsString(state.selectedItem.createdAt)}</Form.Text></Col>
                    </Row>
                </Form.Group>
            </Col>
            <Col sm={12} xl={6}>
            ...
            <Col sm={12} xl={6}>
                <Form.Group className="mb-3" controlId="vehicleCategory.updatedAt">
                    <Row>
                        ...
                        <Col sm={8}><Form.Text>{getDateTimeAsString(state.selectedItem.updatedAt)}</Form.Text></Col>
                    </Row>
                </Form.Group>
            </Col>
        </Row>
